...
[Special Callouts](https://github.com/ahseyg/special-callouts) eklentisinin (v1.0.7) tüm
...
İçerik, eklentinin dokümantasyonundan değil **v1.0.7 kaynak kodundan** (parser, processor ve
...
Special Callouts **v1.0.7** için yazıldı. Parametre sözdizimi 1.0.3'ten beri kararlı;

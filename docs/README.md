...
│   ├── 01-studio-and-builders.md              # Studio modal, visual grid builder, editor toolbar, Save as Preset
│   └── 02-settings-and-management.md          # Modern tabbed settings, universal defaults, palette manager
│
...
Explore the mathematics of CSS `color-mix` neon glows, multi-stop linear gradients, 15% transparent background tints, and unified center alignment.

### 8. [Studio & Interactive Builders](ui-and-modals/01-studio-and-builders.md)
A tour of the Special Callout Studio modal, visual matrix drag/click selection, Save as Preset workflows, and Markdown Editor toolbar with real-time autocompletion.

### 9. [Settings & Palette Management](ui-and-modals/02-settings-and-management.md)
How the tabbed interface manages universal vault defaults with live preview, custom single/multi styles, command palette toggles, and JSON migrations.
